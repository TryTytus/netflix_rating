...
function Card({title, poster_url, rating, vote_count, imdb_id}: CardParams) {
    ...
    <>  
        ...
        >
            {(isOpened) && createPortal((<BigCard is_visible={isVisible} onMouseLeaveTriggered={() => closePopupCard()} top={() => getTop()} left={() => getLeft()} {...{title, poster_url, rating, vote_count, imdb_id}} />), document.body)}
