...
function BigCard({title, poster_url, rating, vote_count, top, left, onMouseLeaveTriggered} : BigCardParams)
{
    ...
    return (
    <>
        <div onMouseLeave={() => onMouseLeaveTriggered()} style={{top: top(), left: left()}} className={`w-[250px] rounded-xl overflow-hidden left-0 top-0 shrink-0 absolute z-50 -translate-x-1/2 -translate-y-1/2`}>
