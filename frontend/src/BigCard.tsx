...
function BigCard({title, poster_url, rating, vote_count, top, left})
{
    ...
    return (
    <>
        <div style={{top, left}} className={`w-[250px] left-0 top-0 shrink-0 absolute z-50 -translate-x-1/2 -translate-y-1/2`}>
